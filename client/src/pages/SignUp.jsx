    ...
    <div className="flex p-3 max-w-3xl mx-auto flex-col md:flex-row gap-5">
      ...
      <div className="flex-1">
        <Link to='/' className="font-bold dark:text-white text-4xl">
          <span className="px-2 py-1 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-lg text-white">Chauhan's</span>
          Blog
        </Link>
      ...
      <div className="flex-1">
        <form className="flex flex-col gap-4">
          ...
          <div>
            ...
            <TextInput type="email" placeholder="name@gmail.com" id="email" name="email" />
          </div>

          <div>
            <Label value="Your password" htmlFor="password" />
            <TextInput type="password" placeholder="Password" id="password" name="password" />
          </div>
